package com.exam.manage.security.filter;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter{
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
		...
		UsernamePasswordAuthenticationToken authRequest = new UsernamePasswordAuthenticationToken(username, result);
		this.setDetails(request, authRequest);


		/*this.checkValidateCode(request);*/
		if("0".equals(userDetails.getEnabled()) || userDetails == null){
